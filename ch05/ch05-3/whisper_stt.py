...
if hf_token is None:
    raise ValueError("HF_TOKEN을 .env에서 읽지 못했습니다.")
...
def speaker_diarization(
    ...
    diarization_output = diarization_pipeline(audio_file_path)
...
def stt_to_rttm(
    ...
    df_rttm["name"] = df_rttm["speaker_id"].map(speaker_name_map).fillna(df_rttm["speaker_id"])
...
if __name__ == "__main__":
    audio_file_path = "../audio/싼기타_비싼기타_16k.wav"
